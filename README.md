...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `79.0µs` | `1.4ms` |
| [Day 2](./src/bin/02.rs) | `264.7µs` | `307.4µs` |
| [Day 3](./src/bin/03.rs) | `250.0µs` | `-` |
| [Day 4](./src/bin/04.rs) | `56.5µs` | `58.7µs` |
| [Day 5](./src/bin/05.rs) | `19.4µs` | `18.6ms` |
| [Day 6](./src/bin/06.rs) | `245.0ns` | `437.0ns` |
