...
| [Day 2](./src/bin/02.rs) | `313.3µs` | `337.3µs` |
| [Day 3](./src/bin/03.rs) | `444.3µs` | `-` |
| [Day 4](./src/bin/04.rs) | `56.7µs` | `58.7µs` |
| [Day 5](./src/bin/05.rs) | `21.8µs` | `21.5ms` |
| [Day 6](./src/bin/06.rs) | `231.0ns` | `1.1ms` |
