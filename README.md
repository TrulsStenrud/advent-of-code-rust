...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `78.7µs` | `1.4ms` |
| [Day 2](./src/bin/02.rs) | `260.8µs` | `305.7µs` |
| [Day 3](./src/bin/03.rs) | `249.6µs` | `-` |
| [Day 4](./src/bin/04.rs) | `57.6µs` | `58.5µs` |
| [Day 5](./src/bin/05.rs) | `19.4µs` | `18.8ms` |
| [Day 6](./src/bin/06.rs) | `242.0ns` | `309.0ns` |
