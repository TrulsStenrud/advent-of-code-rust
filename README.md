...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `82.4µs` | `1.5ms` |
| [Day 2](./src/bin/02.rs) | `322.8µs` | `350.1µs` |
| [Day 3](./src/bin/03.rs) | `436.8µs` | `-` |
| [Day 4](./src/bin/04.rs) | `57.0µs` | `58.3µs` |
| [Day 5](./src/bin/05.rs) | `22.3µs` | `21.5ms` |
| [Day 6](./src/bin/06.rs) | `252.0ns` | `1.1ms` |
